...
/**
 *  @file validation_interface.cpp This file contains implementation related to
...
// LCOV_EXCL_START
static inline constexpr std::optional<std::string_view const>
toString(ValidityIssue const data)
{
