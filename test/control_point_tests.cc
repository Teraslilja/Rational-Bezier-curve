...
struct ControlPointConstructorData
{
  ...
  inline friend std::ostream& operator<<(
    std::ostream& out,
    ControlPointConstructorData const& data)
  {
    out << "{";
...
class ControlPointConstructorTests
  : public ::testing::TestWithParam<ControlPointConstructorData>
{};
...
INSTANTIATE_TEST_SUITE_P(Fixture,
                         ControlPointConstructorTests,
                         ::testing::ValuesIn(controlPointConstructorData));
