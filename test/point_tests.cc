...
TEST(PointOrderTests, Order_2) { EXPECT_EQ(Point2::getOrder(), 2u); }

TEST(PointOrderTests, Order_3) { EXPECT_EQ(Point3::getOrder(), 3u); }
...
struct PointConstructorData {
  ...
  inline friend std::ostream &operator<<(std::ostream &out, PointConstructorData const &data) {
    out << "{";
...
class PointConstructorTests : public ::testing::TestWithParam<PointConstructorData> {};
...
INSTANTIATE_TEST_SUITE_P(Fixture, PointConstructorTests, ::testing::ValuesIn(pointConstructorData));
...
struct PointOperatorMultiplyData {
  ...
  inline friend std::ostream &operator<<(std::ostream &out, PointOperatorMultiplyData const &data) {
    out << "{";
    out << data.xyz << ",";
    out << data.multi;
...
struct PointOperatorDivideData {
  ...
  inline friend std::ostream &operator<<(std::ostream &out, PointOperatorDivideData const &data) {
    out << "{";
    out << data.xyz << ",";
    out << data.divide << ",";
    out << data.expectedResult2 << "," << data.expectedResult3;
...
struct PointOperatorSubstractData {
  ...
  inline friend std::ostream &operator<<(std::ostream &out, PointOperatorSubstractData const &data) {
    out << "{";
    out << data.xyz << ",";
    out << data.substract << ",";
    out << data.expectedResult2 << "," << data.expectedResult3;
...
struct PointOperatorAddData {
  ...
  inline friend std::ostream &operator<<(std::ostream &out, PointOperatorAddData const &data) {
    out << "{";
    out << data.xyz << ",";
    out << data.add << ",";
    out << data.expectedResult2 << "," << data.expectedResult3;
...
struct PointTraceData {
  ...
  inline friend std::ostream &operator<<(std::ostream &out, PointTraceData const &data) {
    out << "{";
    out << data.xyz << ",";
    out << data.expectedResult2 << "," << data.expectedResult3;
    out << "}";
...
struct PointLengthSquaredData {
  ...
  inline friend std::ostream &operator<<(std::ostream &out, PointLengthSquaredData const &data) {
    out << "{";
    out << data.xyz << ",";
    out << data.expectedResult2 << "," << data.expectedResult3;
    out << "}";
...
struct PointLengthData {
  ...
  inline friend std::ostream &operator<<(std::ostream &out, PointLengthData const &data) {
    out << "{";
    out << data.xyz << ",";
    out << data.expectedResult2 << "," << data.expectedResult3;
    out << "}";
...
struct PointDistanceData {
  ...
  inline friend std::ostream &operator<<(std::ostream &out, PointDistanceData const &data) {
    out << "{";
    out << data.xyz << ",";
    out << data.p << ",";
    out << data.expectedResult2 << "," << data.expectedResult3;
...
struct PointNormalizedData {
  ...
  inline friend std::ostream &operator<<(std::ostream &out, PointNormalizedData const &data) {
    out << "{";
    out << data.xyz << ",";
    out << data.expectedResult2 << "," << data.expectedResult3;
    out << "}";
...
class PointOperatorMultiplyTests : public ::testing::TestWithParam<PointOperatorMultiplyData> {};
class PointOperatorDivideTests : public ::testing::TestWithParam<PointOperatorDivideData> {};
class PointOperatorSubstractTests : public ::testing::TestWithParam<PointOperatorSubstractData> {};
class PointOperatorAddTests : public ::testing::TestWithParam<PointOperatorAddData> {};
class PointTraceTests : public ::testing::TestWithParam<PointTraceData> {};
class PointLengthSquaredTests : public ::testing::TestWithParam<PointLengthSquaredData> {};
...
class PointNormalizedTests : public ::testing::TestWithParam<PointNormalizedData> {};
...
static constexpr PointOperatorMultiplyData pointOperatorMultiplyData[]{
    {Point3(real(1.5), real(2.5), real(3.5)), real(2), Point2(real(3), real(5)), Point3(real(3), real(5), real(7))},
};

static constexpr PointOperatorDivideData pointOperatorDivideData[]{
    {Point3(real(2), real(3), real(4)), real(2), Point2(real(1), real(1.5)), Point3(real(1), real(1.5), real(2))},
...
static constexpr PointOperatorSubstractData pointOperatorSubstractData[]{
    {Point3(real(4), real(6), real(8)), Point3(real(1), real(2), real(3)), Point2(real(3), real(4)),
     Point3(real(3), real(4), real(5))},
};

static constexpr PointOperatorAddData pointOperatorAddData[]{
    {Point3(real(4), real(6), real(8)), Point3(real(1), real(2), real(3)), Point2(real(5), real(8)),
...
static constexpr PointDistanceData pointDistanceData[]{
    {Point3(real(1), real(1), real(1)), Point3(real(4), real(5), real(1)), real(5), real(5)},
};

static inline constexpr real one_over_sqrt_2 = real(1) / std::numbers::sqrt2_v<real>;
...
static constexpr PointNormalizedData pointNormalizedData[]{
    ...
    {Point3(real(0), real(0), real(2)), std::nullopt, Point3(real(0), real(0), real(1))},
    {Point3(real(1), real(1), real(1)), Point2(one_over_sqrt_2, one_over_sqrt_2),

     Point3(one_over_sqrt_3, one_over_sqrt_3, one_over_sqrt_3)},
};

INSTANTIATE_TEST_SUITE_P(Fixture, PointOperatorMultiplyTests, ::testing::ValuesIn(pointOperatorMultiplyData));
INSTANTIATE_TEST_SUITE_P(Fixture, PointOperatorDivideTests, ::testing::ValuesIn(pointOperatorDivideData));
INSTANTIATE_TEST_SUITE_P(Fixture, PointOperatorSubstractTests, ::testing::ValuesIn(pointOperatorSubstractData));
INSTANTIATE_TEST_SUITE_P(Fixture, PointOperatorAddTests, ::testing::ValuesIn(pointOperatorAddData));
INSTANTIATE_TEST_SUITE_P(Fixture, PointTraceTests, ::testing::ValuesIn(pointTraceData));
INSTANTIATE_TEST_SUITE_P(Fixture, PointLengthSquaredTests, ::testing::ValuesIn(pointLengthSquaredData));
INSTANTIATE_TEST_SUITE_P(Fixture, PointLengthTests, ::testing::ValuesIn(pointLengthData));
INSTANTIATE_TEST_SUITE_P(Fixture, PointDistanceTests, ::testing::ValuesIn(pointDistanceData));
INSTANTIATE_TEST_SUITE_P(Fixture, PointNormalizedTests, ::testing::ValuesIn(pointNormalizedData));
